...
- Öffne das File in QGIS und schau dir die Attribute an

::::{.content-visible when-profile="musterloesung"}
:::{.callout-note}
## Musterlösung

- {{< var datasets.swissboundaries3d.url >}}
- Shortlink (für diesen Kurs): {{< var datasets.swissboundaries3d.shorturl >}}
